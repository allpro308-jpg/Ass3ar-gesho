...
const APP_BUILD = 'content-navigation-2026-09-17'
import {
  ArrowLeft,
  ArrowRight,
  Bell,
...
function PhoneShell({ children }: { children: React.ReactNode }) {
  return <div className="phone-wrap" data-build={APP_BUILD}><div className="phone-shell"><div className="status-bar"><span>9:41</span><span className="status-icons">▮▮▮ ◔ ▰</span></div>{children}</div></div>
}
